...
const IMPACT_MATRIX = {
  financial: {
    label: "ผลกระทบทางการเงิน",
    icon: "💰",
    color: "#DC2626",
    tooltips: {
      1: "กระทบน้อยมาก สูญเสียไม่เกินระดับเล็กน้อย",
      2: "กระทบต่ำ เริ่มมีค่าใช้จ่ายเพิ่ม",
      3: "กระทบปานกลาง ต้องใช้ทรัพยากรเสริม",
      4: "กระทบสูง รายได้/ต้นทุนเสียหายชัดเจน",
      5: "กระทบรุนแรง เสี่ยงต่อความอยู่รอดของธุรกิจ",
    },
  },
  regulatory: {
    label: "ผลกระทบด้านกฎหมาย/กำกับ",
    icon: "⚖️",
    color: "#7C3AED",
    tooltips: {
      1: "ไม่กระทบข้อกำหนดสำคัญ",
      2: "มีผลเล็กน้อย ต้องปรับปรุงเอกสาร",
      3: "มีความเสี่ยงผิดข้อกำหนดบางส่วน",
      4: "เสี่ยงถูกตรวจพบและถูกลงโทษ",
      5: "เสี่ยงผิดกฎหมายร้ายแรง/ถูกระงับการดำเนินงาน",
    },
  },
  reputation: {
    label: "ผลกระทบด้านชื่อเสียง",
    icon: "📣",
    color: "#EA580C",
    tooltips: {
      1: "แทบไม่กระทบภาพลักษณ์",
      2: "กระทบเฉพาะภายในกลุ่มเล็ก",
      3: "ลูกค้าบางส่วนเริ่มกังวล",
      4: "กระทบวงกว้าง มีการร้องเรียนชัดเจน",
      5: "เสียความเชื่อมั่นรุนแรงในตลาด",
    },
  },
  operational: {
    label: "ผลกระทบด้านการปฏิบัติงาน",
    icon: "🏭",
    color: "#1565C0",
    tooltips: {
      1: "งานชะลอเล็กน้อย",
      2: "กระทบบางขั้นตอนแต่ยังให้บริการได้",
      3: "กระทบหลัก ต้องจัดลำดับความสำคัญใหม่",
      4: "การให้บริการหลักหยุดชะงักบางส่วน",
      5: "การให้บริการหลักหยุดชะงักเกือบทั้งหมด",
    },
  },
};
...
export default function BIAWizardPage({ orgId, pkg, onUpgrade, deps }) {
  ...
  const loadDepartments = async () => {
    ...
    if (error) {
      console.error("Failed to load org departments for wizard", error);
      return;
    }
    const names = (data ?? [])
          ...
          {step===1 && (
            <div style={{ background:"#FFFFFF", borderRadius:14, padding:22,
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12 }}>
                <div>
                  <label style={{ fontSize:11, fontWeight:600, color:"#475569",
                    fontFamily:"'Kanit',sans-serif", display:"block", marginBottom:5 }}>ฝ่าย/แผนก</label>
                  <select
                ...
                <div>
                  <label style={{ fontSize:11, fontWeight:600, color:"#475569",
                    fontFamily:"'Kanit',sans-serif", display:"block", marginBottom:5 }}>เจ้าของกระบวนการ</label>
                  <input value={form.owner} onChange={e=>setForm(p=>({...p,owner:e.target.value}))}
                    placeholder="ชื่อ-นามสกุล หัวหน้า"
                    style={{ width:"100%", padding:"9px 12px", background:"#E8F0FE",
                      border:"1px solid #C5D4F0", borderRadius:8, color:"#0D1B3E",
                      fontSize:12, fontFamily:"'Kanit',sans-serif", boxSizing:"border-box" }}/>
                </div>
